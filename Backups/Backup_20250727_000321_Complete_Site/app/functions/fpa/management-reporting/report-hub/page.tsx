...
import { filterReports, generateAllReports, getRecommendations, reportCategories, searchReports } from '@/lib/report-hub-data';
                        ...
                        <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
                            <div className="min-w-0">
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Access 600+ reports and dashboards across your organization
                                </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between overflow-hidden">
                            ...
                            <div className="flex items-center space-x-3 flex-shrink-0">
                                ...
                                <button
                                    ...
                                    className={`p-2 rounded-lg border transition-colors ${showFilters ? 'bg-blue-50 border-blue-200 text-blue-600' : 'border-gray-200 hover:bg-gray-50'
                                        }`}
                                >
