...
export const EXISTING_PLATFORMS = {
    // Procure to Pay Platforms (from P2P image)
    INTELLIGENT_INVOICE: 'Intelligent Invoice Processing Platform',
    STRATEGIC_SPEND: 'Strategic Spend Analytics Platform',
    SUPPLIER_COLLABORATION: 'Supplier Collaboration Portal',

    // Order to Cash Platforms (from O2C image)
    INTELLIGENT_RECEIVABLES: 'Intelligent Receivables Platform',
    CUSTOMER_EXPERIENCE: 'Customer Experience Portal',
    REVENUE_INTELLIGENCE: 'Revenue Intelligence Suite',

    // Cost Accounting Platforms (from Cost image)
    DYNAMIC_COST_ENGINE: 'Dynamic Cost Engine',
    PROFITABILITY_ANALYTICS: 'Profitability Analytics Platform',
    INVENTORY_INTELLIGENCE: 'Inventory Intelligence System',

    // Controllership Platforms (from Controllership image)
    CONTINUOUS_CLOSE: 'Continuous Close Platform',
    CONTROL_COMPLIANCE: 'Control & Compliance Suite',
    FINANCIAL_REPORTING_HUB: 'Financial Reporting Hub',

    // Corporate Finance Platforms (from Tax & Treasury image)
    TREASURY_COMMAND: 'Treasury Command Center',
    TAX_INTELLIGENCE: 'Tax Intelligence Platform',
    RISK_MANAGEMENT: 'Risk Management Suite',

    // FP&A Platforms (from FP&A image)
    CONNECTED_ENTERPRISE: 'Connected Enterprise Planning Platform',
    MANAGEMENT_REPORTING: 'Management Reporting Platform',

    // Investor Relations Platforms (from IR image)
    EARNINGS_INTELLIGENCE: 'Earnings Intelligence Platform',
    STAKEHOLDER_ENGAGEMENT: 'Stakeholder Engagement Hub',
...
export const ACTIVITY_TO_PLATFORM_MAPPING: PlatformMapping[] = [
    ...
    },
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.STRATEGIC_SPEND,
        platformGap: false,
    ...
    },
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.REVENUE_INTELLIGENCE,
        suggestedPlatform: undefined,
        platformGap: false,
    ...
    {
        activity: 'Revenue Assurance Control Management',
    ...
    },
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.INVENTORY_INTELLIGENCE,
        platformGap: false,
    ...
    // CONTROLLERSHIP (RECORD TO REPORT)
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.FINANCIAL_REPORTING_HUB,
        platformGap: false,
    ...
    },
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.RISK_MANAGEMENT,
        platformGap: false,
    ...
    {
        activity: 'Data / System Effectiveness & Governance',
        subActivities: ['Data quality', 'System optimization'],
        currentPlatform: EXISTING_PLATFORMS.CONNECTED_ENTERPRISE,
        platformGap: false,
        aiAgentsRequired: ['SE', 'DQ', 'SC']
    },
    ...
    // INVESTOR RELATIONS
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.EARNINGS_INTELLIGENCE,
        platformGap: false,
    ...
    },
    {
        ...
        currentPlatform: EXISTING_PLATFORMS.STAKEHOLDER_ENGAGEMENT,
        platformGap: false,
        aiAgentsRequired: ['IC', 'AC', 'TA']
    },
    {
        activity: 'Marketing & Events',
        subActivities: ['Investor days', 'Roadshows'],
        currentPlatform: EXISTING_PLATFORMS.STAKEHOLDER_ENGAGEMENT,
        platformGap: false,
        aiAgentsRequired: ['ME', 'RC', 'VI']
    }
];
...
export function analyzePlatformGaps() {
    ...
    const gapsByFunction = {
        ...
        'Revenue Operations': ACTIVITY_TO_PLATFORM_MAPPING.filter(a =>
            a.suggestedPlatform === EXISTING_PLATFORMS.REVENUE_INTELLIGENCE && a.platformGap).length,
    ...
    return {
        ...
        gapsByFunction,
        missingPlatforms: [EXISTING_PLATFORMS.INTELLIGENT_INVOICE, EXISTING_PLATFORMS.CUSTOMER_EXPERIENCE, EXISTING_PLATFORMS.REVENUE_INTELLIGENCE, EXISTING_PLATFORMS.INTELLIGENT_RECEIVABLES, EXISTING_PLATFORMS.CUSTOMER_EXPERIENCE, EXISTING_PLATFORMS.SUPPLIER_COLLABORATION]
    };
}
