...
export const fpAndAWorkflows: SubActivity[] = [
    ...
    },
    {
        ...
        totalSteps: 4,
        aiAgentsUsed: [
            { agentId: 'SP', frequency: 1 },
            { agentId: 'BI', frequency: 1 },
            { agentId: 'DG', frequency: 1 },
            { agentId: 'TA', frequency: 2 },
            { agentId: 'SM', frequency: 1 },
            { agentId: 'MC', frequency: 1 },
            { agentId: 'OM', frequency: 1 },
            { agentId: 'AM', frequency: 1 },
            { agentId: 'DP', frequency: 1 },
            { agentId: 'PA', frequency: 1 },
            { agentId: 'WA', frequency: 1 },
    ...
    },
    {
        ...
        currentStateWorkflow: [
            ...
            },
            {
                ...
                currentState: {
                    activities: ['Resource allocation analysis', 'Constraint identification', 'Trade-off analysis'],
                    timeRequired: '3-4 days',
                    painPoints: ['Manual optimization', 'Limited scenario analysis', 'Suboptimal allocation']
                },
                futureState: {
                    activities: ['AI resource optimization', 'Automated constraint solving', 'Multi-scenario analysis'],
                    aiAgents: ['OM', 'DP', 'WA', 'SM'],
                    humanCheckpoints: ['Resource allocation approval', 'Strategic priority validation'],
                    timeReduction: '80% reduction'
                }
            },
            {
                stepNumber: 3,
                description: 'Enterprise Plan Assembly',
                currentState: {
                    activities: ['Plan integration', 'Executive summary creation', 'KPI alignment'],
                    timeRequired: '3 days',
                    painPoints: ['Manual assembly', 'Version control', 'KPI inconsistencies']
                },
                futureState: {
                    activities: ['Automated plan assembly', 'AI-driven insights', 'Dynamic KPI tracking'],
                    aiAgents: ['MR', 'KT', 'IR', 'PM'],
                    humanCheckpoints: ['Executive review', 'Final plan approval'],
                    timeReduction: '75% reduction'
                }
            }
        ],
    ...
    },
    {
        ...
        totalSteps: 4,
        aiAgentsUsed: [
            { agentId: 'BP', frequency: 2 },
            { agentId: 'DG', frequency: 1 },
            { agentId: 'TB', frequency: 1 },
            { agentId: 'VA', frequency: 1 },
            { agentId: 'CA', frequency: 1 },
            { agentId: 'BI', frequency: 1 },
            { agentId: 'GP', frequency: 1 },
            { agentId: 'SM', frequency: 1 },
            { agentId: 'AP', frequency: 1 },
            { agentId: 'MR', frequency: 2 },
            { agentId: 'CR', frequency: 1 },
            { agentId: 'DA', frequency: 1 }
        ],
        humanCheckpointsCount: 6,
    ...
    },
    {
        ...
        totalSteps: 4,
        aiAgentsUsed: [
            { agentId: 'RF', frequency: 2 },
            { agentId: 'DG', frequency: 1 },
            { agentId: 'TA', frequency: 1 },
            { agentId: 'DP', frequency: 1 },
            { agentId: 'SM', frequency: 1 },
            { agentId: 'MC', frequency: 1 },
            { agentId: 'PA', frequency: 2 },
            { agentId: 'VA', frequency: 1 },
            { agentId: 'IR', frequency: 1 },
            { agentId: 'RS', frequency: 1 },
            { agentId: 'MR', frequency: 1 },
            { agentId: 'DA', frequency: 1 },
            { agentId: 'CR', frequency: 1 },
            { agentId: 'PM', frequency: 1 }
    ...
    {
        name: 'Decision Support & Modeling',
        ...
        aiAgentsUsed: [
            ...
            { agentId: 'CA', frequency: 1 },
            { agentId: 'MC', frequency: 1 },
            { agentId: 'OM', frequency: 2 },
            { agentId: 'WA', frequency: 1 },
            { agentId: 'PA', frequency: 2 },
            { agentId: 'BP', frequency: 1 },
            { agentId: 'IR', frequency: 1 },
            { agentId: 'CR', frequency: 1 },
            { agentId: 'MR', frequency: 1 },
            { agentId: 'AP', frequency: 1 }
