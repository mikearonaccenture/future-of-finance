...
import { controllershipAdditionalWorkflows } from '@/workflows/controllership-additional-workflows';
import { controllershipStatutoryWorkflows } from '@/workflows/controllership-statutory-workflows';
import { corporateFinanceAdditionalWorkflows } from '@/workflows/corporate-finance-additional-workflows';
...
import { fpaAdditionalWorkflows } from '@/workflows/fpa-additional-workflows';
import { fpAndAWorkflows } from '@/workflows/fpa-workflows';
import { investorRelationsAdditionalWorkflows } from '@/workflows/investor-relations-additional-workflows';
...
import { procureToPayAdditionalWorkflows } from '@/workflows/procure-to-pay-additional-workflows';
...
const PLATFORM_MAPPING = {
    ...
    'controllership': [
        ...
        },
        {
            ...
            activities: ['ctrl-r2r-lease-accounting', 'ctrl-r2r-partner-revenue-accounting', 'ctrl-r2r-project-accounting', 'ctrl-r2r-bs-reconciliation-analytics', 'ctrl-r2r-perform-joint-venture-accounting', 'ctrl-help-desk']
        },
        {
...
const allWorkflows = [
    ...
    ...procureToPayAdditionalWorkflows,
    ...orderToCashWorkflows,
    ...recordToReportWorkflows,
    ...controllershipAdditionalWorkflows,
    ...controllershipStatutoryWorkflows,
    ...fpAndAWorkflows,
    ...fpaAdditionalWorkflows,
    ...corporateFinanceWorkflows,
    ...corporateFinanceAdditionalWorkflows,
    ...costAccountingWorkflows,
    ...investorRelationsWorkflows,
    ...investorRelationsAdditionalWorkflows
];
...
const workflowMap: { [key: string]: string[] } = {
    ...
    'fpa-decision-support-modelling': ['Decision Support & Modeling'],
...
export default function WorkflowsPage() {
    ...
    const toggleFunction = (functionId: string) => {
        ...
        if (newExpanded.has(functionId)) {
            ...
            const platforms = PLATFORM_MAPPING[functionId] || [];
            platforms.forEach(p => {
                ...
                <div style={{ display: 'flex', height: 'calc(100vh - 80px)' }}>
                    ...
                    <div style={{
                        ...
                        {MASTER_FINANCE_TAXONOMY.map(func => {
                            ...
                            const platforms = PLATFORM_MAPPING[func.id] || [];
