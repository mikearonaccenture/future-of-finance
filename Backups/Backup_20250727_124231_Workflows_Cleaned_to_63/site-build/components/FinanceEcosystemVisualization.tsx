...
const getWorkflowsForPlatform = (platformName: string) => {
    ...
    activities.forEach(activity => {
        ...
        if (platformName === EXISTING_PLATFORMS.INTELLIGENT_INVOICE ||
            platformName === EXISTING_PLATFORMS.EMPLOYEE_EXPERIENCE) {
        ...
        } else if (platformName === EXISTING_PLATFORMS.REVENUE_OPERATIONS ||
            platformName === EXISTING_PLATFORMS.WORKING_CAPITAL ||
            platformName === EXISTING_PLATFORMS.CUSTOMER_PORTAL) {
        ...
        } else if (platformName === EXISTING_PLATFORMS.CONTROLLERSHIP) {
...
export default function FinanceEcosystemVisualization() {
    ...
    const platformsByFunction = {
        'Procure to Pay': [
            EXISTING_PLATFORMS.INTELLIGENT_INVOICE,
            EXISTING_PLATFORMS.EMPLOYEE_EXPERIENCE
        ],
        'Order to Cash': [
            EXISTING_PLATFORMS.REVENUE_OPERATIONS,
            EXISTING_PLATFORMS.WORKING_CAPITAL,
            EXISTING_PLATFORMS.CUSTOMER_PORTAL
        ],
        'Controllership': [EXISTING_PLATFORMS.CONTROLLERSHIP],
        'Corporate Finance': [
        ...
        'Cost Accounting': [EXISTING_PLATFORMS.COST_ACCOUNTING],
        'Investor Relations': [EXISTING_PLATFORMS.INVESTOR_RELATIONS]
    };
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem' }}>
                    {Object.entries(platformsByFunction).map(([functionName, platforms]) => {
                        const activityCount = ACTIVITY_TO_PLATFORM_MAPPING.filter(
                            mapping => platforms.includes(mapping.currentPlatform)
                        ).length;
