...
import { Activity, ArrowRight, BarChart3, BookOpen, Brain, ChevronDown, Coins, CreditCard, DollarSign, Eye, Factory, FileText, Globe, Megaphone, Receipt, Shield, Sparkles, Users } from 'lucide-react';
    ...
    'procure-to-pay': {
        ...
        platforms: [
            ...
            },
            {
                ...
                description: "Vendor management and reconciliation excellence",
                capabilities: [
                    "Automated vendor statement reconciliation",
                    "Real-time AP balance management",
                    "Supplier portal with self-service capabilities",
                    "Proactive vendor relationship insights"
                ],
                isAvailable: false
            },
            {
                ...
                description: "Streamlined employee-initiated spend and analytics",
                capabilities: [
                    "Smart procurement card management",
                    "AI-powered travel & expense processing",
    ...
    'controllership': {
        ...
        platforms: [
            ...
            },
            {
                ...
                description: "Master policy, controls, and group reporting",
                capabilities: [
                    "Policy and control management automation",
                    "Intelligent consolidation and eliminations",
                    "Financial statement preparation with disclosures",
                    "Statutory and GAAP adjustment tracking"
                ],
                isAvailable: false
            },
            {
                icon: <Megaphone />,
                title: "Statutory Reporting Hub",
                description: "Streamlined external reporting and audit management",
                capabilities: [
                    "Multi-jurisdiction statutory reporting",
                    "Regulatory filing automation",
                    "Audit request management and tracking",
    ...
    'corporate-finance': {
        ...
        platforms: [
            ...
            },
            {
                ...
                description: "Treasury risk management and performance analytics",
                capabilities: [
                    "Treasury accounting automation",
                    "Financial risk monitoring and hedging",
                    "Treasury KPI tracking and reporting",
                    "Liquidity and funding analytics"
                ],
                isAvailable: false
            }
        ],
        ...
        platforms: [
            {
                ...
                description: "Master investor relations and earnings management",
                capabilities: [
                    "AI-generated earnings materials",
                    "Quarterly earnings preparation automation",
                    "Predictive Q&A with suggested responses",
                    "Investor perception tracking"
                ],
                isAvailable: false
            },
            {
                ...
                description: "Stay ahead with competitive and market insights",
                capabilities: [
                    "Real-time competitive intelligence monitoring",
                    "Stock surveillance and driver analysis",
                    "Investment community relationship management",
                    "Market sentiment and trend analytics"
                ],
                isAvailable: false
            }
        ],
                        ...
                        <div key={idx} style={{
                            ...
                            {platform.isAvailable && selectedFunction === 'fpa' && (
                                <div style={{
                                    ...
                                    <Link
                                        href={'href' in platform && platform.href ? platform.href : "/functions/fpa/forecasting"}
                                        style={{
                                            display: 'inline-flex',
                                            alignItems: 'center',
                                            gap: '0.375rem',
