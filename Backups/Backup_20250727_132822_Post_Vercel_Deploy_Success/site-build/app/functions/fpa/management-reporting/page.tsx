...
export default function ManagementReportingPlatform() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <SEO
                title="Management Reporting Platform - Automated Financial Intelligence"
                description="Transform your financial reporting with AI automation. Real-time dashboards, automated month-end close, executive summaries, and business performance analytics in one intelligent platform."
            />
