...
export const orderToCashWorkflows: SubActivity[] = [
    {
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['O2C-BM', 'O2C-AP', 'O2C-EA'], // Balance Monitor, Aging Predictor, Exposure Analyzer
                    humanCheckpoints: [],
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['O2C-RS', 'O2C-CP', 'O2C-DM'], // Risk Scorer, Collection Prioritizer, Default Modeler
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['O2C-KA', 'O2C-TA', 'O2C-CF'], // KPI Analyzer, Trend Analyzer, Cash Flow Modeler
                    humanCheckpoints: [],
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['O2C-SO', 'O2C-CL', 'O2C-PT'], // Strategy Optimizer, Credit Limit Recommender, Payment Term Modeler
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['O2C-RG', 'O2C-PM', 'O2C-AT'], // Report Generator, Provision Modeler, Audit Tracker
        ...
        aiAgentsUsed: ['O2C-BM', 'O2C-AP', 'O2C-EA', 'O2C-RS', 'O2C-CP', 'O2C-DM', 'O2C-KA', 'O2C-TA', 'O2C-CF', 'O2C-SO', 'O2C-CL', 'O2C-PT', 'O2C-RG', 'O2C-PM', 'O2C-AT'],
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['DA', 'CV', 'PE', 'TE'], // Data Aggregator, Completion Verifier, Pricing Engine, Tax Engine
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['TS', 'LG', 'DE', 'RC'], // Template Selector, Line Generator, Discount Engine, Real-time Calculator
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['AV', 'CC', 'AW', 'EA'], // Accuracy Validator, Compliance Checker, Approval Workflow, Exception Automator
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['OD', 'FC', 'DR', 'RT'], // Omnichannel Distributor, Format Converter, Delivery Router, Real-time Tracker
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['PP', 'IP', 'DM', 'SE'], // Portal Provisioner, Invoice Poster, Document Manager, Self-service Enabler
                    humanCheckpoints: [],
                    timeReduction: '80% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['IR', 'AI', 'AE', 'SA'], // Inquiry Resolver, Automated Investigator, Adjustment Engine, Self-service Adjustments
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['AP', 'DS', 'RS', 'WD'], // Account Prioritizer, Dynamic Segmenter, Risk Scorer, Work Distributor
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['OO', 'CA', 'PM', 'TE'], // Omnichannel Orchestrator, Conversation Assistant, Personalized Messenger, Timing Engine
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['PT', 'FO', 'PS', 'PI'], // Promise Tracker, Follow-up Optimizer, Promise Scorer, Proactive Intervener
                    humanCheckpoints: [],
                    timeReduction: '80% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['CA', 'PG', 'AR', 'AP'], // Capacity Analyzer, Plan Generator, Approval Router, Agreement Processor
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['DC', 'AI', 'DR', 'PR'], // Dispute Categorizer, Automated Investigator, Document Retriever, Predictive Resolver
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['ER', 'LD', 'AM', 'RO'], // Escalation Recommender, Legal Documenter, Agency Matcher, ROI Optimizer
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['PM', 'AA', 'ML', 'EA'], // Payment Matcher, Automated Allocator, Machine Learning, Exception Automator
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['DC', 'AC', 'DR', 'RP'], // Deduction Capturer, AI Categorizer, Document Retriever, Real-time Processor
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['AR', 'AV', 'PR', 'PA'], // AI Researcher, Automated Verifier, Pattern Recognizer, Predictive Analytics
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['CA', 'CC', 'VS', 'DA'], // Contract Analyzer, Compliance Checker, Validity Scorer, Decision Automator
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['RR', 'AC', 'SE', 'DP'], // Resolution Recommender, Automated Communicator, Settlement Engine, Digital Processor
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['RO', 'AF', 'PC', 'WR'], // Recovery Optimizer, Automated Follow-up, Predictive Collector, Write-off Recommender
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['RD', 'TA', 'PP', 'SU'], // Real-time Dashboard, Trend Analyzer, Predictive Preventer, Stakeholder Updater
                    humanCheckpoints: [],
                    timeReduction: '80% reduction'
                }
            }
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['BI', 'PC', 'RP', 'FS'], // Bank Integrator, Payment Capturer, Real-time Processor, Format Standardizer
                    humanCheckpoints: [],
                    timeReduction: '90% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['CM', 'FL', 'ML', 'AE'], // Customer Matcher, Fuzzy Logic, Machine Learning, Automated Enricher
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['IM', 'AE', 'DH', 'OA'], // Invoice Matcher, Allocation Engine, Discount Handler, Optimization Algorithm
                    humanCheckpoints: [],
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['ER', 'CO', 'PM', 'SL'], // Exception Resolver, Customer Outreach, Predictive Matcher, Self-learner
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['AP', 'RR', 'VA', 'DR'], // Automated Poster, Real-time Reconciler, Variance Analyzer, Dynamic Reporter
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['AC', 'RS', 'QR', 'SP'], // Automated Confirmer, Real-time Statementer, Query Resolver, Self-service Portal
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            }
        ...
        currentStateWorkflow: [
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['OI', 'TC', 'SC', 'AA'], // Omnichannel Integrator, Ticket Creator, Smart Categorizer, Auto Acknowledger
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['CA', 'SR', 'LB', 'PE'], // Content Analyzer, Skill Router, Load Balancer, Predictive Escalator
                    humanCheckpoints: [],
                    timeReduction: '90% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['UD', 'AR', 'DR', 'KB'], // Unified Data, AI Researcher, Document Retriever, Knowledge Base
                    humanCheckpoints: [],
                    timeReduction: '80% reduction'
                }
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['SR', 'PC', 'SA', 'QA'], // Solution Recommender, Policy Checker, Smart Approver, Quality Automator
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['RG', 'DP', 'CS', 'AF'], // Response Generator, Dynamic Personalizer, Channel Selector, Automated Follow-up
            ...
            },
            {
                ...
                futureState: {
                    ...
                    aiAgents: ['CW', 'FC', 'SA', 'RI'], // Closure Workflow, Feedback Collector, Sentiment Analyzer, Real-time Insights
                    humanCheckpoints: [],
                    timeReduction: '85% reduction'
                }
            }
