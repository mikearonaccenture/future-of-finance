    ...
    return (
        <div className="bg-gray-50">
                    ...
                    <div className="flex items-center justify-between h-16 flex-wrap gap-4">
                        <div className="flex items-center space-x-4 min-w-0">
                            <div className="min-w-0">
                                <h1 className="text-2xl font-bold text-gray-900 truncate">Monthly Operating Report</h1>
                                <p className="text-sm text-gray-500 truncate">{selectedMonth} • Board & Executive Review</p>
                            </div>
                        </div>
            ...
            <div className="bg-white border-b border-gray-200 overflow-hidden">
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex space-x-1 overflow-x-auto -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
